...
class image_processing_node:
	def __init__(self, name):
		...
		self.subscriber_colour = rospy.Subscriber('/camera/color/image_raw/compressed', CompressedImage, self.callback_colour)

		#This ain't working, it runs once. != None doesn't work anymore when image starts coming
		r = rospy.Rate(10)
	...
	def loop(self):
		if type(self.colour_frame) == np.ndarray:
...
if __name__ == '__main__':
	print("Starting ROS Images Processing Module")
